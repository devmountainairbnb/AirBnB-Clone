...
const SVG = ({
  ...
  >
    <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        <g id="Iron" transform="translate(0.000000, 1.000000)" stroke={color} strokeWidth="2">
            <path d="M1,6 L1,20 L37.9671954,20 C37.4526094,12.1819682 30.9482427,6 23,6 L1,6 Z" id="Rectangle"></path>
            <path d="M12,0.5 L26,0.5" id="Line-7" strokeLinecap="square"></path>
            <path d="M25.5,1.5 L25.5,6" id="Line-8" strokeLinecap="square"></path>
            ...
            <path d="M1,24.5 L38,24.5" id="Line-9" strokeLinecap="square"></path>
        </g>
    </g>
  </svg>
);
