...
const SVG = ({
  ...
  >
    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <g id="Indoor-Fireplace" transform="translate(1.000000, 0.000000)" stroke="#FFFFFF" stroke-width="2">
            ...
            <path d="M0,35 L40,35.1808781" id="Line-3" stroke-linecap="square"></path>
            ...
            <path d="M7,28.5 L13.5,28.5" id="Line-4" stroke-linecap="square"></path>
            <path d="M26,28.5 L32.5,28.5" id="Line-4-Copy" stroke-linecap="square"></path>
        </g>
    </g>
  </svg>
);
