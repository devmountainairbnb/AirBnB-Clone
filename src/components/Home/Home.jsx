...
import { BookingCardInput, BookingCardButton, BookingDateInput, CancelButton } from './../StyledComponents/StyledComponents'
            ...
            <div>
                ...
                {/* login toggle */}
                    <div className={toggleLogin ? 'login' : 'login hidden'}>
                        ...
                        {/* <BookingCardButton login>Login</BookingCardButton> */}
                    </div>
